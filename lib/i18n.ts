...
const en = {
  ...
  filterEasy: "Easy only",
  filterEasyDesc: "Cards you rated 良好 or 简单 last time",
  filterHardEasy: "Hard + Easy",
  filterHardEasyDesc: "All previously reviewed cards",
...
const zh: typeof en = {
  ...
  filterEasy: "只复习简单",
  filterEasyDesc: "上次标记为良好或简单的卡片",
  filterHardEasy: "困难 + 简单",
  filterHardEasyDesc: "所有已复习过的卡片",
  selectHSKLevel: "选择等级",
